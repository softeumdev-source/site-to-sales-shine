...
const groups: FeatureGroup[] = [
  {
    ...
    emoji: "⚡",
    icon: Mail,
    title: "Recebimento automático de pedidos",
    pitch: "Seus pedidos chegam e já entram no sistema, sem digitação manual.",
    bullets: [
      "Leitura automática de e-mails",
      "Processamento de múltiplos pedidos por e-mail",
      "Anexos organizados e acessíveis dentro do sistema",
    ],
  ...
  },
  {
    ...
    emoji: "🤖",
    icon: Brain,
    title: "Leitura inteligente com IA",
    pitch: "O sistema lê o pedido e preenche tudo pra você.",
    bullets: [
      "Extração automática de dados do pedido",
      "Identificação de todos os itens",
      "Indicador de confiabilidade para validação rápida",
    ],
  ...
  },
  {
    ...
    pitch: "Você acompanha tudo que está acontecendo, ao vivo.",
    bullets: [
      "Atualização automática sem precisar recarregar",
      "Visão clara de pedidos pendentes, aprovados e erros",
      "Filtros rápidos para encontrar qualquer pedido",
    ],
  ...
  },
  {
    ...
    emoji: "✏️",
    icon: Edit3,
    title: "Revisão rápida e assistida",
    pitch: "Corrija ou valide pedidos em segundos.",
    bullets: [
      "Campos totalmente editáveis",
      "Cálculos automáticos",
      "Destaque visual de possíveis erros",
